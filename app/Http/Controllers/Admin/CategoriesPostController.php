...
class CategoriesPostController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['data'] = Categories::where('type', 'news_category')->get();
    ...
    public function store(Request $request)
    {
        ...
        $post_check_sulg = Categories::where('slug', $request->slug)->where('type', 'news_category')->first();
    ...
    public function edit($id)
    {
        ...
        $data['categories'] = Categories::where('id', '!=', $id)->where('type', 'news_category')->get();
