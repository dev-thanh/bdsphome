...
class Products extends Model
{
    ...
    protected $fillable = ['sku', 'name', 'slug', 'image', 'sort_desc', 'content', 'specifications', 'title_attributes' ,'regular_price','sale_price','sale', 'is_hot','is_flash_sale', 'show_home', 'status', 'brand_id', 'meta_title', 'meta_description', 'meta_keyword', 'order_sale_page', 'time_priority','price_priority', 'image_hover', 'volume','color_content','cd_content','spkh','more_image'
    ];
