					...
					<div class="tab-container">
						...
						<div class="tab-content">
							<div class="tab-item id-category-news active" id="all" data-cate="all">
                                <div class="tab__project">
                                    @foreach($posts as $item)
									<div class="project__item">
                                        <a href="{{route('home.single-project',['slug'=>$item->slug])}}" class="project__box" title="Aqua City">
                                            <div class="frame">
                                                <img src="{{url('/').$item->image}}" alt="project_1.png">
                                            </div>
                                            <div class="project__content">
                                                ...
                                                <span href="{{route('home.single-project',['slug'=>$item->slug])}}" class="btn btn__global" title="Chi tiết">
                                                    Chi tiết
                                                </span>
                                            </div>
                                        </a>
							...
							<div class="tab-item id-category-news" id="tab{{$k+1}}" data-cate="{{$value->id}}">
								<div class="tab__project">
									@if(!empty($value->projects))
										<?php $news = $value->projects()->where('status',1)->paginate(10); ?>
										@foreach($news as $val)
										<div class="project__item">
