               	...
               	<form action="{!! updateOrStoreRouteRender( @$module['action'], $module['module'], @$data) !!}" method="POST">
				    ...
				    <div class="nav-tabs-custom">
		                <ul class="nav nav-tabs">
		                    <li class="active">
		                        <a href="#activity" data-toggle="tab" aria-expanded="true">Danh mục bất động sản</a>
		                    </li>
							<li class="">
		                ...
		                <div class="tab-content">
		                    <div class="tab-pane active" id="activity">
								...
								<div class="form-group">
									...
									<select name="category_nd" class="form-control">
										<option value="">Loại nhà đất</option>
										@foreach($cateNd as $item)
										<option value="{{$item->id}}" @if(@$data->category_nd==$item->id) selected @endif>{{$item->name}}</option>
										@endforeach
									</select>
								</div>
								<!-- <div class="form-group">
